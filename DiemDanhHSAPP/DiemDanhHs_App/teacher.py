...
class Teacher:
    def __init__(self,root):
        ...
        if user_role != 0:  # Nếu user_role khác 0, vô hiệu hóa các nút
        ...
        self.AttendanceReportTable = ttk.Treeview(table_frame, column=("id", "name", "phone", "email", "quest", "answer", "pass"),
